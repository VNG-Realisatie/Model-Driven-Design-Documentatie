...
- Binnen de zojuist gekozen of vervaardigde folder check je vervolgens de modellen repository uit. Dit doe je door met de rechtermuistoets op de folder te klikken en dan te kiezen voor 'SVN Checkout...'. Het volgende menu verschijnt:<br/<br/>![SVN Checkout...](./images/Checkout.jpg)<br/><br/>

...
In [3 Het drie-lagen model](./Drielagen-model) is al uitgelegd hoe SIM's, UGM's en BSM's met elkaar verweven zijn. In dit hoofdstuk beschrijven we hoe deze modellen daadwerkelijk opgesteld kunnen worden.
...
- In [4.2 Het opstellen van een horizontaal Semantisch InformatieModel](./Opstellen-SIM) wordt uitgelegd hoe een horizontaal SIM wordt gecreëerd.
...
- [4.3 Het opstellen van een horizontaal GegevensUitwisselingsModel](./Opstellen-UGM) gaat over het creeren van horizontale UitwiselingsGegevensModellen.
